<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Jenis Tambah</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-success box-solid">
        ...
        <div class="box-body" style="">
          ...
          <form method="post" action="?action=jenis_tambah_post">
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="name" class="form-control" name="jenis_code" placeholder="Masukkan kode" required>
                    </div>
