<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Supplier Tambah</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-success box-solid">
        ...
        <div class="box-body" style="">
          ...
          <form method="post" action="?action=supplier_tambah_post">
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="name" class="form-control" name="supplier_kode" placeholder="Masukkan kode" required>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <a href="?page=supplier&parent=manajemen" class="btn btn-danger">Back</a>
                    </div>
                  </div>
                </div>
              </div>
